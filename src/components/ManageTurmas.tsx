...
const ManageTurmas = ({ onTurmasChanged }: ManageTurmasProps) => {
  ...
  // Retirado o 'contact' pois não existe na tabela e causava a falha na BD
  ...
  // ========================================================================
  // MOTOR DE GRAVAÇÃO BLINDADO COM TRY/CATCH
  // ========================================================================
            ...
            <div className={`bg-white border border-slate-200 p-5 rounded-xl shadow-sm transition-all ${editingStudentId ? 'ring-4 ring-blue-50 border-blue-300' : ''}`}>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  <button onClick={handleSaveStudent} disabled={loading} className="flex-1 bg-slate-900 text-white py-3 rounded-lg font-bold text-sm hover:bg-slate-800 flex items-center justify-center gap-2 transition-colors disabled:opacity-50">
